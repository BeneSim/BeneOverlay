...
BOGroupBox {
  ...
  property var data_ref_enabled: data_ref_manager.getDataRef("widget/altitude/enabled")
  property var data_ref_custom_style: data_ref_manager.getDataRef("widget/altitude/custom_style")
  property var data_ref_icon_enabled: data_ref_manager.getDataRef("widget/altitude/icon_enabled")
  property var data_ref_icon_size: data_ref_manager.getDataRef("widget/altitude/icon_size")
  property var data_ref_primary_color: data_ref_manager.getDataRef("widget/altitude/primary_color")
  property var data_ref_secondary_color: data_ref_manager.getDataRef("widget/altitude/secondary_color")
  property var data_ref_primary_font: data_ref_manager.getDataRef("widget/altitude/primary_font")
  property var data_ref_secondary_font: data_ref_manager.getDataRef("widget/altitude/secondary_font")
  ...
  BOSwitch {
      id: vs_enabled_switch

      anchors.top: alt_enabled_switch.bottom
      anchors.left: parent.left
  ...
  BOSwitch {
    ...
    anchors.top: vs_enabled_switch.bottom
    anchors.left: parent.left
