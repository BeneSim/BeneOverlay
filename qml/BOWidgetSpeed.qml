...
BOGroupBox {
  ...
  property var data_ref_enabled: data_ref_manager.getDataRef("widget/speed/enabled")
  property var data_ref_custom_style: data_ref_manager.getDataRef("widget/speed/custom_style")
  property var data_ref_icon_enabled: data_ref_manager.getDataRef("widget/speed/icon_enabled")
  property var data_ref_icon_size: data_ref_manager.getDataRef("widget/speed/icon_size")
  property var data_ref_primary_color: data_ref_manager.getDataRef("widget/speed/primary_color")
  property var data_ref_secondary_color: data_ref_manager.getDataRef("widget/speed/secondary_color")
  property var data_ref_primary_font: data_ref_manager.getDataRef("widget/speed/primary_font")
  property var data_ref_secondary_font: data_ref_manager.getDataRef("widget/speed/secondary_font")
