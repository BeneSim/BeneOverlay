...
BOGroupBox {
  ...
  property var data_ref_settings_mode: data_ref_manager.getDataRef("landing/settings_mode")
  property var data_ref_background_image_enabled: data_ref_manager.getDataRef("landing/background_image_enabled")
  property var data_ref_background_image: data_ref_manager.getDataRef("landing/background_image")
  property var data_ref_custom_style: data_ref_manager.getDataRef("landing/custom_style")
  property var data_ref_icon_enabled: data_ref_manager.getDataRef("landing/icon_enabled")
  property var data_ref_icon_size: data_ref_manager.getDataRef("landing/icon_size")
  property var data_ref_primary_color: data_ref_manager.getDataRef("landing/primary_color")
  property var data_ref_secondary_color: data_ref_manager.getDataRef("landing/secondary_color")
  property var data_ref_primary_font: data_ref_manager.getDataRef("landing/primary_font")
  property var data_ref_secondary_font: data_ref_manager.getDataRef("landing/secondary_font")
  ...
  BOSwitch {
    ...
    data_ref: root.data_ref_settings_mode
  }

  Button {
      id: test_event_button

      anchors.top: settings_mode_switch.bottom
      anchors.left: parent.left
  ...
  BOSpinBox {
    id: popup_duration_spin_box

    anchors.top: test_event_button.visible ? test_event_button.bottom : settings_mode_switch.bottom
    anchors.left: parent.left
  ...
  BOSwitch {
    ...
    anchors.top: popup_duration_spin_box.bottom
    anchors.left: parent.left

    name: "Background Image"
    description: "Enable background image"
    data_ref: root.data_ref_background_image_enabled
  }

  BOImageSelector {

    id: background_image_image_selector

    anchors.top: background_image_enabled_switch.bottom
    anchors.left: parent.left

    name: "Background Image"
    data_ref: root.data_ref_background_image
  ...
  BOSwitch {
    ...
    anchors.top: background_image_image_selector.visible? background_image_image_selector.bottom : background_image_enabled_switch.bottom
    anchors.left: parent.left
