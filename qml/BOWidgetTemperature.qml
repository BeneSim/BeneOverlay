...
BOGroupBox {
  ...
  property var data_ref_enabled: data_ref_manager.getDataRef("widget/temperature/enabled")
  property var data_ref_custom_style: data_ref_manager.getDataRef("widget/temperature/custom_style")
  property var data_ref_icon_enabled: data_ref_manager.getDataRef("widget/temperature/icon_enabled")
  property var data_ref_icon_size: data_ref_manager.getDataRef("widget/temperature/icon_size")
  property var data_ref_primary_color: data_ref_manager.getDataRef("widget/temperature/primary_color")
  property var data_ref_secondary_color: data_ref_manager.getDataRef("widget/temperature/secondary_color")
  property var data_ref_primary_font: data_ref_manager.getDataRef("widget/temperature/primary_font")
  property var data_ref_secondary_font: data_ref_manager.getDataRef("widget/temperature/secondary_font")
  ...
  BOSwitch {
    ...
    anchors.top: tat_enabled_switch.bottom
    anchors.left: parent.left
